...
class TestBookRoutesIntegration:
    @pytest.mark.asyncio
    async def test_get_user_books_empty(self, async_client, auth_headers):
    ...
    @pytest.mark.asyncio
    async def test_upload_book_invalid_file_type(self, async_client, auth_headers):
    ...
    @pytest.mark.asyncio
    async def test_upload_book_no_file(self, async_client, auth_headers):
    ...
    @pytest.mark.asyncio
    async def test_get_user_book_not_found(self, async_client, auth_headers):
    ...
    @pytest.mark.asyncio
    async def test_update_book_not_found(self, async_client, auth_headers):
    ...
    @pytest.mark.asyncio
    async def test_delete_book_not_found(self, async_client, auth_headers):
    ...
    @pytest.mark.asyncio
    async def test_share_book_not_found(self, async_client, auth_headers):
    ...
    @pytest.mark.asyncio
    async def test_get_shared_books_empty(self, async_client, auth_headers):
    ...
    @pytest.mark.asyncio
    async def test_get_books_shared_by_me_empty(self, async_client, auth_headers):
    ...
    @pytest.mark.asyncio
    async def test_update_user_book_not_found(self, async_client, auth_headers):
    ...
    @pytest.mark.asyncio
    async def test_upload_book_large_file(self, async_client, auth_headers):
